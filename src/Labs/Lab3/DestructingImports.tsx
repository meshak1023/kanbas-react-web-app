...
import Math, { add, subtract, multiply, divide } from "./Math"; // Import default and named exports
import * as Matematica from "./Math"; // Import everything as Matematica
    ...
    return (
        <div id="wd-destructuring-imports">
            ...
            <table className="table table-sm">
                ...
                <tbody>
                {/* Example using different import styles */}
                <tr>
